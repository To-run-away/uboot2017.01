...
#if CONFIG_CMD_NET
#define CONFIG_ETHADDR      00:09:c0:ff:ec:48	
...
#define MTDIDS_DEFAULT		"mmc0=s5p-mmc0"
#define MTDPARTS_DEFAULT	"mtdparts=s5p-mmc0:1m(bootloader)"\
				",256k(params)"\
				",2816k(config)"\
				",8m(csa)"\
				",7m(kernel)"\
...
#define CONFIG_BOOTARGS	"root=/dev/mtdblock8 rootfstype=ext4 " \
			CONFIG_COMMON_BOOT
#define CONFIG_BOOTARGS "root=/dev/nfs nfsroot=192.168.0.101:/home/run/work/rootfs/rootfs_3.16.57 ip=192.168.0.20:192.168.0.101:192.168.0.1:255.255.255.0::eth0:off init=/linuxrc console=ttySAC2,115200"
#endif
...
#define PHYS_SDRAM_1		CONFIG_SYS_SDRAM_BASE	/* DDR2 DMC0 Bank #0 */
#define PHYS_SDRAM_1_SIZE	(256 << 20)		/* 256 MB in Bank #0 */
#define PHYS_SDRAM_2		0x40000000		/* DDR2 DMC1 Bank #1 */
#define PHYS_SDRAM_2_SIZE	(256 << 20)		/* 256 MB in Bank #1 */
...
#define CONFIG_ENV_OFFSET		(512 << 10) /* 32KiB - 4KiB */
#define CONFIG_ENV_OVERWRITE
